    ...
    <section className="bg-[#f5f3ef] text-[#172b1b]">
      ...
      <div className="container mx-auto px-6 md:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mb-16">
          {/* Email */}
          <div className="group bg-[#e9e3db] p-8 rounded-xl shadow-lg hover:shadow-2xl transition hover:bg-[#172b1b] hover:text-[#e9e3db]">
            <Mail
              size={40}
              className="mx-auto mb-4 text-[#172b1b] group-hover:text-[#e9e3db]"
            />
        ...
        {/* Contact Form */}
        <div className="max-w-3xl mx-auto bg-[#172b1b] p-10 rounded-2xl shadow-xl">
        ...
        <div className="max-w-4xl mx-auto mt-16 text-center">
          <h3 className="text-2xl font-bold text-[#172b1b] mb-4">
            Why Reach Out to Us?
          </h3>
          <p className="text-[#172b1b]/80 leading-relaxed mb-6">
            Whether you have a question, want to discuss a project, or simply
            need guidance, our team is here to help. We aim to respond to all
            queries within <span className="font-semibold">24 hours</span>.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            ...
            <div className="bg-[#717552] text-[#e9e3db] p-6 rounded-lg shadow hover:shadow-lg transition">
              ...
              <p className="text-sm text-[#e9e3db]/80">
                Our team is approachable, professional, and always happy to
                help.
              </p>
            </div>
            <div className="bg-[#717552] text-[#e9e3db] p-6 rounded-lg shadow hover:shadow-lg transition">
